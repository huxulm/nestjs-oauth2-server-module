...
export class OAuth2Request {
    ...
    /* @ApiModelProperty({
        type: Number,
        description: 'The expiration time of the assertion, specified as seconds
        since 00:00:00 UTC, January 1, 1970. This value has a maximum of 1 hour after the issued time.',
    }) */
    @Expose({ name: "exp" })
    exp?: number;
